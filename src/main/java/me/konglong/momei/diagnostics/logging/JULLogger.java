...
class JULLogger implements Logger {
    ...
    @Override
    public void info(String msgTemplate, Object... msgArgs) {
    ...
    @Override
    public void warn(String msgTemplate, Object... msgArgs) {
        log(WARNING, msgTemplate, msgArgs);
    }
    ...
    private void log(final Level level, String msgTemplate, Object... msgArgs) {
        msgTemplate = msgTemplate.replaceAll("\\{\\}", "%s");
        delegate.log(level, String.format(msgTemplate, msgArgs));
    }
